...
/// <summary>
/// Records which dispatches the connector has already delivered, so at-least-once delivery does not POST twice.
/// The realization of the "idempotent consumers deduplicate by event id" invariant.
/// </summary>
