...
/// <summary>
/// Records which events the twin has already folded in, so at-least-once delivery does not re-apply an
/// observation. The realization of the "idempotent consumers deduplicate by event id" invariant.
/// </summary>
