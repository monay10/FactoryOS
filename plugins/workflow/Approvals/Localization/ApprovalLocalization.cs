...
namespace FactoryOS.Plugins.Workflow.Approvals.Localization;

/// <summary>Resolves localized display text for approval titles and messages.</summary>
public interface IApprovalLocalizer
{
...
/// <summary>
/// An in-memory <see cref="IApprovalLocalizer"/>. Translations are registered per culture and key; resolution
/// falls back to the supplied default when a culture or key is missing, so an approval always has a title.
/// </summary>
public sealed class InMemoryApprovalLocalizer : IApprovalLocalizer
{
