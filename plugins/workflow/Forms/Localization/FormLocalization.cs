...
namespace FactoryOS.Plugins.Forms.Engine.Localization;

/// <summary>Resolves localized display text for form labels, options and messages.</summary>
...
/// <summary>
/// An in-memory <see cref="IFormLocalizer"/>. Translations are registered per culture and key; resolution
/// falls back to the supplied default when a culture or key is missing, so a form always renders.
/// </summary>
public sealed class InMemoryFormLocalizer : IFormLocalizer
{
