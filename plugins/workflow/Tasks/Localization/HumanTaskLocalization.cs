...
namespace FactoryOS.Plugins.Workflow.Tasks.Localization;

/// <summary>Resolves localized display text for human task titles and messages.</summary>
public interface IHumanTaskLocalizer
{
...
/// <summary>
/// An in-memory <see cref="IHumanTaskLocalizer"/>. Translations are registered per culture and key; resolution
/// falls back to the supplied default when a culture or key is missing, so a task always has a title.
/// </summary>
public sealed class InMemoryHumanTaskLocalizer : IHumanTaskLocalizer
{
