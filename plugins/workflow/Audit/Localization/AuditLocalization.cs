...
namespace FactoryOS.Plugins.Workflow.Audit.Localization;

/// <summary>Resolves localized display text for audit actions and messages.</summary>
...
/// <summary>
/// An in-memory <see cref="IAuditLocalizer"/>. Translations are registered per culture and key; resolution
/// falls back to the supplied default when a culture or key is missing.
/// <para>
/// Localization applies to how a record is <b>displayed</b>, never to what is stored: the recorded message and
/// the hashed content stay in the language they were written in, so translating a UI can never alter a trail
/// or invalidate its chain.
/// </para>
/// </summary>
public sealed class InMemoryAuditLocalizer : IAuditLocalizer
{
