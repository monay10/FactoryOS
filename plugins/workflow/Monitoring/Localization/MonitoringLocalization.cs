...
namespace FactoryOS.Plugins.Workflow.Monitoring.Localization;

/// <summary>Resolves localized display text for metrics, health checks and alerts.</summary>
public interface IMonitoringLocalizer
{
...
/// <summary>
/// An in-memory <see cref="IMonitoringLocalizer"/>. Translations are registered per culture and key; resolution
/// falls back to the supplied default when a culture or key is missing.
/// <para>
/// Localization applies to how a measurement is <b>displayed</b>, never to what is stored. Metric keys, label
/// names and label values stay in the language they were defined in — translating a dashboard must not be able
/// to split one series into two, which is exactly what a localized label value would do.
/// </para>
/// </summary>
public sealed class InMemoryMonitoringLocalizer : IMonitoringLocalizer
{
